...
{
    public partial class MBtViviendasError : Form
    {
        bool SiExporto = false;
        public MBtViviendasError()
        {
            InitializeComponent();
        }

        private void MBtViviendasError_Load(object sender, EventArgs e)
        {
            string Registradas = "";
        ...
        {
            if (MessageBox.Show("¿Desea regresar a Módulo Selección del Plano?", "Regresar", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MDatosFinales sdp = new MDatosFinales();
                Modelo.EncDatosConfiguracion.ConDatos = true;
                Modelo.EncDatosPlano.M2SuperFloteTipo.Clear();
                sdp.Show();                
                Modelo.EncDatosConfiguracion.CierreAuto = true;
        ...
        private void MBtViviendasError_FormClosing(object sender, FormClosingEventArgs e)
        {
